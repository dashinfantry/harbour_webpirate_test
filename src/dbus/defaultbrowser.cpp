...
const QString DefaultBrowser::LOCAL_SERVICE = "org.harbour.webpirate_test.service";
const QString DefaultBrowser::OPEN_URL = "harbour-webpirate_test-open-url.desktop";
...
void DefaultBrowser::writeLocalOpenUrl() const
{
    ...
    f.write(QString("[Desktop Entry]\n"
                    "Type=Application\n"
                    "Name=Open with WebPirate (test)\n"
                    "Icon=harbour-webpirate_test\n"
                    "NoDisplay=true\n"
                    "MimeType=text/html;x-scheme-handler/http;x-scheme-handler/https;\n"
                    "X-Maemo-Service=org.harbour.webpirate_test\n"
                    "X-Maemo-Method=org.harbour.webpirate_test.openUrl\n").toUtf8());
...
void DefaultBrowser::writeLocalService() const
{
    ...
    f.write(QString("[D-BUS Service]\n"
                    "Name=org.harbour.webpirate_test\n"
                    "Exec=/usr/bin/invoker -s --type=silica-qt5 /usr/bin/harbour-webpirate_test\n").toUtf8());
